...
#ifndef MOCAPNOISEGENERATION_H
#define MOCAPNOISEGENERATION_H
...
class MoCapNoiseGeneration
{
//	Q_OBJECT
public:
    MoCapNoiseGeneration();
    ~MoCapNoiseGeneration();
