...
IUAVGadget *UAVGadgetInstanceManager::createGadget(QString classId, QWidget *parent, bool loadDefault)
{
    IUAVGadgetFactory *f = factory(classId);
    if (f) {
        ...
        IUAVGadget *gadget = new UAVGadgetDecorator(g, configs, loadDefault);
