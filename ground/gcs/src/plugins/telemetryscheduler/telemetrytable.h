...
#ifndef TELEMETRYTABLE_H
#define TELEMETRYTABLE_H
...
class TelemetryTable : public QAbstractTableModel
{
    Q_OBJECT
public:
    explicit TelemetryTable(QObject *parent = 0);
...
private:
    ...
    WaypointActive *telemetryItemActiveObj;
    QList <QString> headers;
    int elements;
};

#endif // TELEMETRYTABLE_H
