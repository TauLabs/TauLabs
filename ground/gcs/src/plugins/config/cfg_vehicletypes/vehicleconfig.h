...
class VehicleConfig: public ConfigTaskWidget
{
    ...
    public:
        ...
        typedef enum { MIXERTYPE_DISABLED=0, MIXERTYPE_MOTOR=1, MIXERTYPE_CARMOTOR=2, MIXERTYPE_SERVO=3, MIXERTYPE_CAMERAROLL=4, MIXERTYPE_CAMERAPITCH=5, MIXERTYPE_CAMERAYAW=6, MIXERTYPE_ACCESSORY0=7, MIXERTYPE_ACCESSORY1=8, MIXERTYPE_ACCESSORY2=9, MIXERTYPE_ACCESSORY3=10, MIXERTYPE_ACCESSORY4=11, MIXERTYPE_ACCESSORY5=12 } MixerTypeElem;
