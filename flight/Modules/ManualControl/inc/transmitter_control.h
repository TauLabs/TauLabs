...
( (int)MANUALCONTROLSETTINGS_FLIGHTMODEPOSITION_RATE == (int) FLIGHTSTATUS_FLIGHTMODE_RATE) && \
( (int)MANUALCONTROLSETTINGS_FLIGHTMODEPOSITION_ATTITUDE == (int) FLIGHTSTATUS_FLIGHTMODE_ATTITUDE) && \
