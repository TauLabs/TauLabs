...
((int)MANUALCONTROLSETTINGS_STABILIZATION1SETTINGS_ENHANCEDATTITUDE  == (int)STABILIZATIONDESIRED_STABILIZATIONMODE_ENHANCEDATTITUDE)   && \
...
((int)MANUALCONTROLSETTINGS_STABILIZATION2SETTINGS_ENHANCEDATTITUDE  == (int)STABILIZATIONDESIRED_STABILIZATIONMODE_ENHANCEDATTITUDE)  && \
...
((int)MANUALCONTROLSETTINGS_STABILIZATION3SETTINGS_ENHANCEDATTITUDE  == (int)STABILIZATIONDESIRED_STABILIZATIONMODE_ENHANCEDATTITUDE)  && \
