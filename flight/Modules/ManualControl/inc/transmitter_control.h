...
((int)MANUALCONTROLSETTINGS_STABILIZATION1SETTINGS_ATTITUDEPLUS  == (int)STABILIZATIONDESIRED_STABILIZATIONMODE_ATTITUDEPLUS)   && \
...
((int)MANUALCONTROLSETTINGS_STABILIZATION2SETTINGS_ATTITUDEPLUS  == (int)STABILIZATIONDESIRED_STABILIZATIONMODE_ATTITUDEPLUS)  && \
...
((int)MANUALCONTROLSETTINGS_STABILIZATION3SETTINGS_ATTITUDEPLUS  == (int)STABILIZATIONDESIRED_STABILIZATIONMODE_ATTITUDEPLUS)  && \
