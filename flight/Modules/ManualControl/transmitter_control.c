...
static void update_stabilization_desired(ManualControlCommandData * cmd, ManualControlSettingsData * settings)
{
	...
	const uint8_t ACROPLUS_SETTINGS[3] = {  
	                                    ...
	                                    STABILIZATIONDESIRED_STABILIZATIONMODE_ACROPLUS,
	                                    STABILIZATIONDESIRED_STABILIZATIONMODE_RATE};
	const uint8_t LQG_RATE_SETTINGS[3] = {
	                                    STABILIZATIONDESIRED_STABILIZATIONMODE_LQGRATE,
	                                    STABILIZATIONDESIRED_STABILIZATIONMODE_LQGRATE,
	                                    STABILIZATIONDESIRED_STABILIZATIONMODE_LQGRATE};
	const uint8_t LQG_ANGLE_SETTINGS[3] = {
	                                    STABILIZATIONDESIRED_STABILIZATIONMODE_LQGANGLE,
	                                    STABILIZATIONDESIRED_STABILIZATIONMODE_LQGANGLE,
	                                    STABILIZATIONDESIRED_STABILIZATIONMODE_LQGRATE};
	...
	switch(flightMode) {
		...
		case FLIGHTSTATUS_FLIGHTMODE_AXISLOCK:
			...
			break;
		case FLIGHTSTATUS_FLIGHTMODE_LQGRATE:
			stab_settings = LQG_RATE_SETTINGS;
			break;
		case FLIGHTSTATUS_FLIGHTMODE_LQGANGLE:
			stab_settings = LQG_ANGLE_SETTINGS;
			break;
		case FLIGHTSTATUS_FLIGHTMODE_STABILIZED1:
	...
	stabilization.Roll = (stab_settings[0] == STABILIZATIONDESIRED_STABILIZATIONMODE_NONE) ? cmd->Roll :
	     ...
	     (stab_settings[0] == STABILIZATIONDESIRED_STABILIZATIONMODE_LQGRATE) ? expo3(cmd->Roll, stabSettings.RateExpo[STABILIZATIONSETTINGS_RATEEXPO_ROLL]) * stabSettings.ManualRate[STABILIZATIONSETTINGS_MANUALRATE_ROLL] :
	     (stab_settings[0] == STABILIZATIONDESIRED_STABILIZATIONMODE_LQGANGLE) ? expo3(cmd->Roll, stabSettings.AttitudeExpo[STABILIZATIONSETTINGS_ATTITUDEEXPO_ROLL]) * stabSettings.RollMax :
	...
	stabilization.Pitch = (stab_settings[1] == STABILIZATIONDESIRED_STABILIZATIONMODE_NONE) ? cmd->Pitch :
	     ...
	     (stab_settings[1] == STABILIZATIONDESIRED_STABILIZATIONMODE_LQGRATE) ? expo3(cmd->Pitch, stabSettings.RateExpo[STABILIZATIONSETTINGS_RATEEXPO_PITCH]) * stabSettings.ManualRate[STABILIZATIONSETTINGS_MANUALRATE_PITCH] :
	     (stab_settings[1] == STABILIZATIONDESIRED_STABILIZATIONMODE_LQGANGLE) ? expo3(cmd->Pitch, stabSettings.AttitudeExpo[STABILIZATIONSETTINGS_ATTITUDEEXPO_PITCH]) * stabSettings.PitchMax :
	...
	stabilization.Yaw = (stab_settings[2] == STABILIZATIONDESIRED_STABILIZATIONMODE_NONE) ? cmd->Yaw :
	     ...
	     (stab_settings[2] == STABILIZATIONDESIRED_STABILIZATIONMODE_LQGRATE) ? expo3(cmd->Yaw, stabSettings.RateExpo[STABILIZATIONSETTINGS_RATEEXPO_YAW]) * stabSettings.ManualRate[STABILIZATIONSETTINGS_MANUALRATE_YAW] :
	     (stab_settings[2] == STABILIZATIONDESIRED_STABILIZATIONMODE_LQGANGLE) ? expo3(cmd->Yaw, stabSettings.AttitudeExpo[STABILIZATIONSETTINGS_ATTITUDEEXPO_YAW]) * stabSettings.YawMax :
