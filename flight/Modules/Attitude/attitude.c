...
static void settingsUpdatedCb(UAVObjEvent * objEv) {
	...
	gyro_correct_int[0] = attitudeSettings.InitialGyroBias[ATTITUDESETTINGS_INITIALGYROBIAS_X] / 100.0f;
	gyro_correct_int[1] = attitudeSettings.InitialGyroBias[ATTITUDESETTINGS_INITIALGYROBIAS_Y] / 100.0f;
	gyro_correct_int[2] = attitudeSettings.InitialGyroBias[ATTITUDESETTINGS_INITIALGYROBIAS_Z] / 100.0f;
