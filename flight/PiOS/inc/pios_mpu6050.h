...
/* Public Functions */
extern int32_t PIOS_MPU6050_Init(uint32_t i2c_id, uint8_t i2c_addr, const struct pios_mpu6050_cfg * new_cfg);
...
extern void PIOS_MPU6050_SetGyroRange(enum pios_mpu6050_range);
extern void PIOS_MPU6050_SetAccelRange(enum pios_mpu6050_accel_range);
