...
extern void PIOS_RFM22B_SetChannelConfig(uint32_t rfm22b_id,
					 enum rfm22b_datarate datarate,
					 uint8_t min_chan,
					 uint8_t max_chan,
					 uint8_t chan_set,
					 bool coordinator, bool oneway,
					 bool ppm_mode, bool ppm_only);
extern void PIOS_RFM22B_SetCoordinatorID(uint32_t rfm22b_id,
					 uint32_t coord_id);
...
extern uint8_t PIOS_RFM2B_GetPairStats(uint32_t rfm22b_id,
				       uint32_t * device_ids,
