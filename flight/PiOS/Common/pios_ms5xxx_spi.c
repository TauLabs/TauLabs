 ...
 */
static int32_t PIOS_MS5XXX_ClaimBus(void)
{
 ...
 * @return 0 if successful
 */
static int32_t PIOS_MS5XXX_ReleaseBus(void)
{
	if (PIOS_MS5XXX_Validate(dev) != 0)
		return -1;
