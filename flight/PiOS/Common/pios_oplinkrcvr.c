...
static int32_t PIOS_OPLinkRCVR_Get(uintptr_t rcvr_id, uint8_t channel);
static void PIOS_oplinkrcvr_Supervisor(uintptr_t ppm_id);
...
extern int32_t PIOS_OPLinkRCVR_Init(uintptr_t *oplinkrcvr_id)
{
    struct pios_oplinkrcvr_dev *oplinkrcvr_dev;
...
static void PIOS_oplinkrcvr_Supervisor(uintptr_t oplinkrcvr_id)
{
