...
#
LINKER_SCRIPTS_APP	 =	$(PIOS_DEVLIB)/link_STM32F3xx_OP_memory.ld \
						$(PIOS_DEVLIB)/link_STM32F3xx_sections.ld

LINKER_SCRIPTS_BL	 =	$(PIOS_DEVLIB)/link_STM32F3xx_BL_memory.ld \
						$(PIOS_DEVLIB)/link_STM32F3xx_sections.ld
