...
// Private constants
#if defined(plop_EVENTDISAPTCHER_QUEUE)
#define MAX_QUEUE_SIZE plop_EVENTDISAPTCHER_QUEUE
#else
#define MAX_QUEUE_SIZE 20
#endif

#if defined(plop_EVENTDISPATCHER_STACK_SIZE)
#define STACK_SIZE plop_EVENTDISPATCHER_STACK_SIZE
#else
#define STACK_SIZE configMINIMAL_STACK_SIZE
#endif /* plop_EVENTDISPATCHER_STACK_SIZE */
