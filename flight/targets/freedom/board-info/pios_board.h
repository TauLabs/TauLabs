...
#define PIOS_COM_MAVLINK_NUM_PORTS 2
extern uintptr_t pios_com_mavlink_id[PIOS_COM_MAVLINK_NUM_PORTS];
...
#define RX_LED_ON
#define RX_LED_OFF
#define TX_LED_ON           PIOS_LED_On(PIOS_LED_LINK)
#define TX_LED_OFF          PIOS_LED_Off(PIOS_LED_LINK)
#define USB_LED_ON
#define USB_LED_OFF
