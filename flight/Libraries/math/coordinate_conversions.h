...
void LLA_linearization_float(int32_t home_latitude, float home_altitude, float linearized_conversion_factor_f[]);
void LLA_linearization_double(int32_t home_latitude, double home_altitude, double linearized_conversion_factor_d[]);
