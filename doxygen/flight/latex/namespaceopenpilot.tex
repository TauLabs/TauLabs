...
\subsubsection[{debug}]{\setlength{\rightskip}{0pt plus 5cm}def openpilot.\-debug (
...
\subsubsection[{delay}]{\setlength{\rightskip}{0pt plus 5cm}def openpilot.\-delay (
\begin{DoxyParamCaption}
...
\subsubsection[{delay\-Until}]{\setlength{\rightskip}{0pt plus 5cm}def openpilot.\-delay\-Until (
\begin{DoxyParamCaption}
...
\subsubsection[{has\-Stop\-Request}]{\setlength{\rightskip}{0pt plus 5cm}def openpilot.\-has\-Stop\-Request (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{wait\-For\-Object\-Updates}]{\setlength{\rightskip}{0pt plus 5cm}def openpilot.\-wait\-For\-Object\-Updates (
\begin{DoxyParamCaption}
\item[{}]{timeout\-Ms}
\end{DoxyParamCaption}
