...
public class OPTelemetryService extends Service {
	...
	// Intent category
	public final static String INTENT_CATEGORY_GCS        = "org.abovegroundlabs.intent.category.GCS";

	// Intent actions
	public final static String INTENT_ACTION_CONNECTED    = "org.abovegroundlabs.intent.action.CONNECTED";
	public final static String INTENT_ACTION_DISCONNECTED = "org.abovegroundlabs.intent.action.DISCONNECTED";
	...
	public boolean loadUavobjects(String jar, UAVObjectManager objMngr) {
		...
		try {
			Class<?> initClass = loader.loadClass("org.abovegroundlabs.uavtalk.uavobjects.UAVObjectsInitialize");
