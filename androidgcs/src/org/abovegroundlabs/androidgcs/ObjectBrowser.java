		...
		((Button) findViewById(R.id.editButton)).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (selected_index > 0) {
					...
					intent.putExtra("org.abovegroundlabs.androidgcs.ObjectName", allObjects.get(selected_index).getName());
					intent.putExtra("org.abovegroundlabs.androidgcs.ObjectId", allObjects.get(selected_index).getObjID());
					intent.putExtra("org.abovegroundlabs.androidgcs.InstId", allObjects.get(selected_index).getInstID());
